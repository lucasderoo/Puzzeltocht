...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('/home/starttrip/start/{tripid}/{number}', 'StarttripController@playtrip');
    Route::post('/home/starttrip/tripscore/{tripid}/{number}', 'StarttripController@tripscore');
